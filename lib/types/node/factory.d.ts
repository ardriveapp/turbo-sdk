...
export declare class TurboFactory extends TurboBaseFactory {
    ...
    static authenticated({ privateKey, signer: providedSigner, paymentServiceConfig, uploadServiceConfig, token, tokenMap, gatewayUrl, tokenTools, walletAdapter, cuUrl, processId, }: TurboAuthenticatedConfiguration): import("./index.js").TurboAuthenticatedClient;
}
