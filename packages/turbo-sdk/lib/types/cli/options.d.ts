...
export declare const optionMap: {
    ...
    readonly walletFile: {
        ...
        readonly description: "Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array";
    };
    readonly privateKey: {
    ...
    readonly dev: {
        readonly alias: "--dev";
        readonly description: "Use the ar.io Testnet Sandbox endpoints";
    ...
    readonly arnsDisplayName: {
        readonly alias: "--display-name <displayName>";
        readonly description: "Display name for the record (Set-Record-Metadata)";
    };
    readonly arnsClearDisplayName: {
        readonly alias: "--clear-display-name";
        readonly description: "Clear the record display name (Set-Record-Metadata)";
        readonly default: false;
    };
    readonly arnsRecordLogo: {
        readonly alias: "--record-logo <transactionId>";
        readonly description: "Arweave transaction ID for the record logo (Set-Record-Metadata)";
    };
    readonly arnsClearRecordLogo: {
        readonly alias: "--clear-record-logo";
        readonly description: "Clear the record logo (Set-Record-Metadata)";
        readonly default: false;
    };
    readonly arnsRecordDescription: {
        readonly alias: "--record-description <description>";
        readonly description: "Description for the record (Set-Record-Metadata)";
    };
    readonly arnsClearRecordDescription: {
        readonly alias: "--clear-record-description";
        readonly description: "Clear the record description (Set-Record-Metadata)";
        readonly default: false;
    };
    readonly arnsRecordKeywords: {
        readonly alias: "--record-keywords <keywords...>";
        readonly description: "Keywords for the record (Set-Record-Metadata)";
        readonly type: "array";
    };
    readonly arnsClearRecordKeywords: {
        readonly alias: "--clear-record-keywords";
        readonly description: "Clear the record keywords (Set-Record-Metadata)";
        readonly default: false;
    };
    readonly arnsAction: {
        readonly alias: "--action <action>";
...
export declare const addArNSControllerOptions: ({
    readonly alias: "-w, --wallet-file <filePath>";
    readonly description: "Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array";
} | {
    readonly alias: "-p, --private-key <key>";
...
export declare const removeArNSControllerOptions: ({
    readonly alias: "-w, --wallet-file <filePath>";
    readonly description: "Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array";
} | {
    readonly alias: "-p, --private-key <key>";
...
export declare const transferArNSRecordOptions: ({
    readonly alias: "-w, --wallet-file <filePath>";
    readonly description: "Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array";
} | {
    readonly alias: "-p, --private-key <key>";
...
export declare const setArNSRecordMetadataOptions: ({
    readonly alias: "-w, --wallet-file <filePath>";
    readonly description: "Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array";
} | {
    readonly alias: "-p, --private-key <key>";
...
export declare const removeArNSRecordMetadataOptions: ({
    readonly alias: "-w, --wallet-file <filePath>";
    readonly description: "Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array";
} | {
    readonly alias: "-p, --private-key <key>";
...
export declare const arnsActionPriceOptions: {
    readonly alias: "--action <action>";
    readonly description: string;
}[];
