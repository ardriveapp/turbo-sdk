...
export declare const SOLANA_USDC_MINT_ADDRESS = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";
export declare const DEVNET_SOLANA_USDC_MINT_ADDRESS = "4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU";
 ...
 */
export declare class SolanaUsdcToken extends SplToken {
    constructor({ gatewayUrl, mintAddress, ...config }?: SolanaUsdcTokenConfig);
}
//# sourceMappingURL=solanaUsdc.d.ts.map