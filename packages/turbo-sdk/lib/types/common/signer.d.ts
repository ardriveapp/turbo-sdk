...
import { FileStreamFactory, NativeAddress, SendTxWithSignerParams, TokenType, TurboDataItemSigner, TurboDataItemSignerParams, TurboFileFactory, TurboLogger, TurboSignedDataItemFactory, TurboSignedRequestHeaders, TurboSigner, TurboX402Signer, WalletAdapter } from '../types.js';
/**
 ...
 * `X402Funding({ signer })`.
 */
export declare function makeX402Signer(arbundlesSigner: ArbundleSigner): Promise<TurboX402Signer>;
