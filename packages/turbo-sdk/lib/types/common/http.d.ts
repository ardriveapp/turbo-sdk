...
import { TurboHTTPServiceInterface, TurboLogger, TurboSignedRequestHeaders, TurboX402Signer, X402RequestCredentials } from '../types.js';
...
type X402FetchModule = {
    wrapFetchWithPayment: (fetchFn: typeof fetch, signer: TurboX402Signer, maxValue?: bigint) => typeof fetch;
};
/**
 ...
 */
export declare function requireX402Fetch(): Promise<void>;
/**
 ...
 */
export declare function __setX402FetchLoaderForTests(loader?: () => Promise<X402FetchModule>): void;
