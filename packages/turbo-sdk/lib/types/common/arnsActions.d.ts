 ...
 */
export declare function buildArNSCustodyMessage(action: 'set-record' | 'remove-record' | 'set-record-metadata' | 'remove-record-metadata' | 'transfer-record', fields: string[]): string;
/**
 ...
 */
export declare function arNSMetadataField(value: string | null | undefined): string;
/**
 ...
 * same signature.
 */
export declare function arNSKeywordsField(keywords: readonly string[] | null | undefined): string;
/**
