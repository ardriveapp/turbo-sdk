 ...
 */
export declare const arNSActions: readonly ["buy-name", "extend-lease", "upgrade-name", "increase-undername-limit", "set-record", "remove-record", "add-controller", "remove-controller", "transfer"];
