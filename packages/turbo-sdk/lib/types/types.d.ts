...
import type { Account, Chain, LocalAccount, Transport, WalletClient } from 'viem';
...
export declare const tokenTypes: readonly ["arweave", "ario", "solana", "ethereum", "matic", "pol", "base-eth", "usdc", "base-usdc", "polygon-usdc", "solana-usdc"];
 ...
 */
export type TurboX402Signer = WalletClient<Transport, Chain, Account> | LocalAccount;
export declare class X402Funding {
    signer: TurboX402Signer | undefined;
