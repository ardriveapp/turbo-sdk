...
import { TurboHTTPService, requireX402Fetch, x402UploadEndpoints, } from './http.js';
...
export class TurboUnauthenticatedUploadService {
    constructor({ url = defaultUploadServiceURL, logger = Logger.default, retryConfig = defaultRetryConfig(logger), token = 'arweave', }) {
            ...
            try {
                ...
                */
                if (x402Options !== undefined &&
                    ...
                    throw new ProvidedInputError(`The signed x402 item is ${dataItemSizeFactory()} bytes, over the ` +
