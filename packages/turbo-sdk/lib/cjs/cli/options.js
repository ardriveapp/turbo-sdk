...
exports.optionMap = {
    ...
    walletFile: {
        ...
        description: 'Wallet file to use with the action. Formats accepted: JWK.json, ETH private key as a string, or SOL Secret Key as a Uint8Array',
    },
    privateKey: {
...
exports.walletOptions = [exports.optionMap.walletFile, exports.optionMap.privateKey];
