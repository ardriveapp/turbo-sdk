...
const solanaUsdc_js_1 = require("./solanaUsdc.js");
...
exports.defaultTokenMap = {
    ...
    'solana-usdc': (config) => new solanaUsdc_js_1.SolanaUsdcToken(config),
};
...
exports.tokenToBaseMap = {
    ...
    'solana-usdc': (a) => (0, usdc_js_1.USDCToTokenAmount)(a),
};
...
__exportStar(require("./spl.js"), exports);
__exportStar(require("./solanaUsdc.js"), exports);
