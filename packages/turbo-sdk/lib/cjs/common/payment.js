...
exports.developmentPaymentServiceURL = 'https://payment.services.ar-io.dev';
...
class TurboUnauthenticatedPaymentService {
    ...
    async getCheckout({ amount, owner, promoCodes = [], uiMode = 'hosted', ...callbackUrls }, type = 'checkout-session', headers) {
        ...
        if (this.token === 'ario' &&
            !(0, common_js_1.isValidArweaveBase64URL)(owner) &&
            (0, common_js_1.isValidSolanaAddress)(owner)) {
