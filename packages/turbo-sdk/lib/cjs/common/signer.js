...
class TurboDataItemAbstractSigner {
    ...
    ownerToNativeAddress(owner, token) {
        switch (token) {
            ...
            case 'base-usdc':
            case 'polygon-usdc':
                return (0, ethers_2.computeAddress)(ethers_2.SigningKey.computePublicKey((0, base64_js_1.fromB64Url)(owner)));
            case 'ario':
                ...
                if (this.signer.signatureType === arbundles_1.SignatureConfig.ED25519 ||
                    this.signer.signatureType === arbundles_1.SignatureConfig.SOLANA) {
                    return bs58_1.default.encode(Uint8Array.from((0, base64_js_1.fromB64Url)(owner)));
                }
