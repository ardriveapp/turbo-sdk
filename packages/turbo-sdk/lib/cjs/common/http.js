...
exports.requireX402Fetch = requireX402Fetch;
exports.__setX402FetchLoaderForTests = __setX402FetchLoaderForTests;
/**
...
// published types.
const loadPeer = () => Promise.resolve().then(() => __importStar(require('x402-fetch')));
 ...
 */
async function requireX402Fetch() {
    await loadX402Fetch();
}
 ...
 */
function __setX402FetchLoaderForTests(loader) {
